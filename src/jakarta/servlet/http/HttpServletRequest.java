...
/**
 *
 * Extends the {@link jakarta.servlet.ServletRequest} interface to provide
...
public interface HttpServletRequest extends ServletRequest {
     ...
     * The mappings for any applicable {@link jakarta.servlet.Filter}s are
     * not indicated in the result.  If the currently active {@link
     * jakarta.servlet.Servlet} invocation was obtained by a call to
     ...
     * jakarta.servlet.AsyncContext#dispatch}, the returned {@code
     * HttpServletMapping} is the one corresponding to the path that
     * caused the first {@code Servlet} in the invocation sequence to be
     * invoked.  See {@link
     * jakarta.servlet.RequestDispatcher#FORWARD_MAPPING}, {@link
     * jakarta.servlet.RequestDispatcher#INCLUDE_MAPPING} and {@link
     * jakarta.servlet.AsyncContext#ASYNC_MAPPING} for additional request
     * attributes related to {@code HttpServletMapping}. If the
     * currently active {@code Servlet} invocation was obtained by a
     * call to {@link jakarta.servlet.ServletContext#getNamedDispatcher},
